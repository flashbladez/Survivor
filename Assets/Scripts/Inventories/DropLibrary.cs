...
{
    [CreateAssetMenu(menuName = ("Survivor/Inventory/Drop Library"))]

    public class DropLibrary : ScriptableObject
    {
        [SerializeField] DropConfig[] potentialDrops;
        [SerializeField] float[] dropChancePercenatge;
        ...
        {
            return UnityEngine.Random.Range(0, 100) < GetByLevel(dropChancePercenatge, level);
        }
        ...
        public Dropped GetRandomDrop(int level)
        {
